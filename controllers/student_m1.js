const Student_m1 = require("../modals/student_m1");

exports.addStudent_M1 = async (req, res) => {
    try{
        ...
        const existingUser = await Student_m1.findOne({email});
        if(existingUser){
        ...
        const student = await Student_m1.create({
            name, 
            email,
            mobile,
            feesh,
...
exports.getAllStudent_M1 = async (req, res) => {
    try{
        const students = await Student_m1.find();
        return res.status(200).json({
            success: true,
...
exports.getStudent_M1 = async (req, res) => {
    try{
        ...
        const student = await Student_m1.findById(_id);
...
exports.updateStudent_M1 = async (req, res) => {
    try {
        const { _id } = req.params;
        const { name, email, mobile, feesh, amount, subject, mark, year, PassinsStatus, progresh } = req.body;
        ...
        let existingUser = await Student_m1.findOne({ _id });
...
exports.deleteStudent_M1 = async (req, res) => {
    try {
        const { _id } = req.params;
        ...
        const deletedUser = await Student_m1.findOneAndDelete({ _id });
...
exports.getAllBacklogStudent_M1 = async (req, res) => {
    try {
        // Find students where PassinsStatus is 'Fail'
        const back_student = await Student_m1.find({ PassinsStatus: 'Fail' });
...
exports.getBacklogStudent_M1 = async (req, res) => {
    try{
        const { _id } = req.params;
        if(!_id){
            return res.status(400).json({
...
exports.deleteBacklogStudent_M1 = async (req, res) => {
    try {
        const { _id } = req.params;
